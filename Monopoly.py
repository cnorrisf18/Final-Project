...
def trade(play, playerlist):
    ...
    while not done:
        ...
        if trade == 'Y' or trade == 'y':
            who=input("Who would you like to trade with? Pick one of the three: {}.".format(copystr))
...
def mainGame():
    print("\033[1m Welcome to Monopoly! Today you will be playing against 3 computer characters. Enjoy!")
